...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmployeeInfo.is_Staff'
        db.add_column(u'Users_employeeinfo', 'is_Staff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmployeeInfo.is_Staff'
        db.delete_column(u'Users_employeeinfo', 'is_Staff')
