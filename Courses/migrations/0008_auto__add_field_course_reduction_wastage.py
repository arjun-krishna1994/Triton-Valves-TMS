...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.reduction_wastage'
        db.add_column(u'Courses_course', 'reduction_wastage',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.reduction_wastage'
        db.delete_column(u'Courses_course', 'reduction_wastage')
