...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BatchDetails.created'
        db.add_column(u'Courses_batchdetails', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BatchDetails.created'
        db.delete_column(u'Courses_batchdetails', 'created')
