...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Grading.probable_date_of_retarining'
        db.delete_column(u'Courses_grading', 'probable_date_of_retarining')

        # Adding field 'Grading.probable_date_of_retraining'
        db.add_column(u'Courses_grading', 'probable_date_of_retraining',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Grading.probable_date_of_retarining'
        db.add_column(u'Courses_grading', 'probable_date_of_retarining',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Grading.probable_date_of_retraining'
        db.delete_column(u'Courses_grading', 'probable_date_of_retraining')
