...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BatchDetails.batch_timings'
        db.delete_column(u'Courses_batchdetails', 'batch_timings')

        # Adding field 'BatchDetails.start_time'
        db.add_column(u'Courses_batchdetails', 'start_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BatchDetails.stop_time'
        db.add_column(u'Courses_batchdetails', 'stop_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BatchDetails.batch_timings'
        db.add_column(u'Courses_batchdetails', 'batch_timings',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True),
                      keep_default=False)

        # Deleting field 'BatchDetails.start_time'
        db.delete_column(u'Courses_batchdetails', 'start_time')

        # Deleting field 'BatchDetails.stop_time'
        db.delete_column(u'Courses_batchdetails', 'stop_time')
